package com.trekr.Common.CarouselPicker;
...
public class CarouselPicker extends ViewPager {
    ...
    public static class CarouselViewAdapter extends PagerAdapter {
        ...
        public CarouselViewAdapter(Context context, List<PickerItem> items, int drawable) {
            ...
            this.items = items;
            if (this.drawable == 0) {
                this.drawable = R.layout.calendar_carouselpicker_page;
            }
        }
            ...
            if (pickerItem.hasDrawable()) {
                ...
                if (pickerItem.getText() != null) {
                    ...
                    if (textSize != 0) {
                        ...
                        if (position == this.fixedPos) {
                            tv.setTextColor(Color.BLACK);
                        } else {
                            if (position == this.fixedPos - 1) {
                                tv.setTextSize(dpToPx(((TextItem) pickerItem).getTextSize() - 2));
                            }
                            if (position == this.fixedPos - 2) {
                                tv.setTextSize(dpToPx(((TextItem) pickerItem).getTextSize() - 3));
                            }
                            if (position == this.fixedPos + 1) {
                                tv.setTextSize(dpToPx(((TextItem) pickerItem).getTextSize() - 2));
                            }
        ...
        public void setFixedColor(int position) {
